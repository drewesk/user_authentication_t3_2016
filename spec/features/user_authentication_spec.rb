...
feature 'User Authentication' do
  ...
  scenario 'does not allow existing user to login with an Invalid password' do
  ...
  scenario 'allows a logged in user to logout' do
    ...
    expect(page).to_not have_text("Signed in as #{user.first_name.titleize}")
    expect(page).to_not have_text("Welcome back #{user.email}")
